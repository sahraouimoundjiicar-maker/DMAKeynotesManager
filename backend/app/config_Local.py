...
# Étape 2.1 — Paramètres de connexion au serveur PostgreSQL
"""
Les valeurs sont lues depuis .env.
Les valeurs par défaut sont utilisées si .env est absent.
"""
POSTGRES_CONFIG = {
...
# Étape 2.2 — Nom de l'unique base de données
"""
Toute l'application utilise une seule BD PostgreSQL.
Elle contient toutes les tables :
super_admin, utilisateurs, projets, categories, notes...
"""
NOM_BD = os.getenv("NOM_BD", "DMAKeynotesDB")
